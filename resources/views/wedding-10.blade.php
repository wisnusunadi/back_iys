...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('template_web/wedding_10/css/bootstrap.css')}}">
  <link rel="stylesheet" href="{{ asset('template_web/wedding_10/css/normalize.css')}}">
  <link rel="stylesheet" href="{{ asset('template_web/wedding_10/css/owl.carousel.css')}}">
  <link rel="stylesheet" href="{{ asset('template_web/wedding_10/css/magnific-popup.css')}}">
  <link rel="stylesheet" href="{{ asset('template_web/wedding_10/css/animate.css')}}">
  <link rel="stylesheet" href="{{ asset('template_web/wedding_10/css/main.css')}}" type="text/css">

  <script src="{{ asset('template_web/wedding_10/js/jquery-1.12.4.min.js')}}">
  </script>
  <script src="{{ asset('template_web/wedding_10/js/modernizr.custom.js')}}"></script>
</head>
...
<body>
  ...
  <div id="main-container">
    ...
    <div class="sections">
      ...
      <section id="home" class="home-section clearfix">
        ...
        <div class="hs-main-content container">
          ...
          <div class="about-us clearfix">
            ...
            <div class="heart">
              <img src="{{ asset('template_web/wedding_10/images/heart_img.png')}}" alt="">
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6 event-block">
              <div class="event-photo scale-image-effect">
                <img src="{{ asset('template_web/wedding_10/images/wedding.webp')}}" alt="">
            ...
            <div class="col-md-6 event-block">
              <div class="event-photo scale-image-effect">
                <img src="{{ asset('template_web/wedding_10/images/celeb.webp')}}" alt="">
              </div>
      ...
      <footer id="thanks" class="footer">
        <div id="footer-image-block" class="footer-image-block" style="background-image: url('{{ asset('template_web/wedding_10/images/cover.webp')}}'); background-attachment: fixed; background-position: 50%;" data-stellar-background-ratio="0.3">
  ...
  <script src="{{ asset('template_web/wedding_10/js/bootstrap.min.js')}}"></script>
  <script src="{{ asset('template_web/wedding_10/js/jquery.stellar.min.js')}}"></script>
  <script src="{{ asset('template_web/wedding_10/js/validator.js')}}"></script>
  <script src="{{ asset('template_web/wedding_10/js/owl.carousel.min.js')}}"></script>
  <script src="{{ asset('template_web/wedding_10/js/jquery.magnific-popup.min.js')}}"></script>
  <script src="{{ asset('template_web/wedding_10/js/jquery.countdown.js')}}"></script>
  <script src="{{ asset('template_web/wedding_10/js/jquery.malihu.PageScroll2id.min.js')}}"></script>
  <script src="{{ asset('template_web/wedding_10/js/main.js')}}"></script>
