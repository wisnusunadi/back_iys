...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('template_web/wedding_8/css/bootstrap.css')}}">
  <link rel="stylesheet" href="{{ asset('template_web/wedding_8/css/normalize.css')}}">
  <link rel="stylesheet" href="{{ asset('template_web/wedding_8/css/owl.carousel.css')}}">
  <link rel="stylesheet" href="{{ asset('template_web/wedding_8/css/magnific-popup.css')}}">
  <link rel="stylesheet" href="{{ asset('template_web/wedding_8/css/animate.css')}}">
  <link rel="stylesheet" href="{{ asset('template_web/wedding_8/css/main.css')}}" type="text/css">

  <script src="{{ asset('template_web/wedding_8/js/jquery-1.12.4.min.js')}}">
  </script>
  <script src="{{ asset('template_web/wedding_8/js/modernizr.custom.js')}}"></script>
</head>
...
<body>
  ...
  <script src="{{ asset('template_web/wedding_8/js/bootstrap.min.js')}}"></script>
  <script src="{{ asset('template_web/wedding_8/js/jquery.stellar.min.js')}}"></script>
  <script src="{{ asset('template_web/wedding_8/js/validator.js')}}"></script>
  <script src="{{ asset('template_web/wedding_8/js/owl.carousel.min.js')}}"></script>
  <script src="{{ asset('template_web/wedding_8/js/jquery.magnific-popup.min.js')}}"></script>
  <script src="{{ asset('template_web/wedding_8/js/jquery.countdown.js')}}"></script>
  <script src="{{ asset('template_web/wedding_8/js/jquery.malihu.PageScroll2id.min.js')}}"></script>
  <script src="{{ asset('template_web/wedding_8/js/main.js')}}"></script>
